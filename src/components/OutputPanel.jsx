...
const OutputPanel = () => (
  <div className="h-1/2 w-full">
    <div className="flex justify-between border-b border-b-light-platinum px-4 py-1 text-light-cornflowerblue dark:border-b-dark-charcoal dark:text-dark-pigmentgreen">
      ...
      <button className="inline-flex h-auto items-center justify-center rounded-full bg-transparent px-4 hover:bg-light-cornflowerblue hover:text-light-white hover:outline-0 dark:hover:bg-dark-pigmentgreen">
        <svg
          width="20"
          height="20"
          viewBox="0 0 15 15"
    ...
    <ScrollArea.Root className="h-full w-full overflow-hidden border-b border-b-light-platinum bg-light-white px-4 dark:border-b-dark-charcoal dark:bg-dark-gunmetal">
      <ScrollArea.Viewport className="size-full"></ScrollArea.Viewport>
